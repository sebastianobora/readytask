...
public class SocialResourceReactionController {
    ...
    public ResponseEntity<ResourceStatisticsResponse> likePost(Authentication authentication, @PathVariable Long postId) {
    ...
    public ResponseEntity<ResourceStatisticsResponse> dislikePost(Authentication authentication, @PathVariable Long postId) {
    ...
    public ResponseEntity<ResourceStatisticsResponse> swapPostReaction(Authentication authentication, @PathVariable Long postId) {
        return ResponseEntity.ok(socialResourceReactionService.swapPostReaction(authentication, postId));
    }

    @DeleteMapping("/{postId}")
    public ResponseEntity<ResourceStatisticsResponse> deleteReaction(Authentication authentication, @PathVariable Long postId) {
